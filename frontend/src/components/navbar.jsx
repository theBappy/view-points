...
import { BookOpenIcon, LayoutDashboardIcon, WaypointsIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
        ...
        >
          <div className="size-10 rounded-xl bg-linear-to-r from-primary via-secondary to-accent flex items-center justify-center shadow-lg">
            <WaypointsIcon className="size-6 text-white" />
          </div>
          ...
          <Link
            ...
            className={`px-4 py-2.5 rounded-lg transition-all duration-200 ${
              isActive("/problems")
                ...
                : "hover:bg-base-200 text-base-content/70 hoer:text-base-content"
            }`}
          >
